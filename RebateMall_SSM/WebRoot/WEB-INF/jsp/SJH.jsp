...
<html>
  ...
  <body>
							...
							<tr>
								<td><i class="icon lock" style="top: 22px;"></i>
									<div class="form-group field-user-password">
										...
										<input type="text" id="phonenumbera"
											class="in_1 form-control" name="phonenumbera"onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" placeholder="请输入新的手机号码" maxlength="11">
										<p class="help-block help-block-error"></p>
									</div></td>
							</tr>
							<tr>
    ...
    window.location.href="${ctx}/securityXXweb/Account.do";
		  ...
		  // 去数字强行输入的字母
            $("#phonenumber,#yanzheng,#phonenumbera").on('blur', function () {
                var $asdfg = $(this);
