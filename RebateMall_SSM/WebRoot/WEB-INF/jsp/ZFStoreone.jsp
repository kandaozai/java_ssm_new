...
<body>
	<header>
		...
		<div class="header_bottom">
			<div class="bottom_center">
				<a href=""><img class="bot_left" src="${ctx}/CQW/image/LOGO.png">
				</a>
				<div class="nav_list">
					<ul>
	...
	<div class="shop mb30 clearfix">
		...
		<div style="height: 320px;" id="focus-banner">
			<ul id="focus-banner-list">
				...
				<li style="z-index: 3; display: list-item;"><a
					style="height: 320px;" href="" class="focus-banner-img"
					target="_blank"><img
			...
			<div class="mall-nav-p">
				...
				<div class="mall-r pull-left">
					...
					<div id="HasLoginFrame" class="mall-r-t text-center myScoreLoading">
						<span class="toux"> <img
							<c:choose><c:when test="${SESSION_USER.headportrait != null}">src="${ctx}/mainsy/getUserPicture.do?file=${SESSION_USER.headportrait}"   onerror="this.onerror=null;this.src='${ctx}/image/WT.png'" </c:when> <c:otherwise> src="${ctx}/CQW/image/user-o.png"  </c:otherwise> </c:choose>>
						</span>


						<c:choose>
							<c:when test="${SESSION_USER.signupId != null}">
								<h3 class="tl color-gray-middle">
									你好：<a href="${ctx}/servlet/personalServlet">${SESSION_USER.signupname}</a>
								</h3>
								<p class="sum MyScore">
								...
								<dl class="_rule">
									<a href="${ctx}/servlet/loginServlet?fun=signin">立即签到</a>
								</dl>
							...
							<c:otherwise>
								<h2 class="">未登陆</h2>
								<dl class="_rule">
									<a href="${ctx}/servlet/loginServlet">立即登陆</a>
								</dl>
							</c:otherwise>
						</c:choose>
		...
		<div class="mask">
			<div class="modal_banner">
				<a href="#" class="closeBtn">×</a> <span class="title_h1 clearfix"><i
					class="fa fa-check"></i>签到成功!<em>+5</em> </span>
			</div>
		</div>
		...
		<div id="yinchang">
			<div class="shop_list mt30 clearfix">
				<div class="hot_shop">
					<h2 class="s_title">查询结果</h2>
				</div>
				<div class="hot_list">
					<ul>

						<c:forEach items="${LXCX}" var="LXCX">

							<li><a href=""> <img
									src="${ctx}/zFStore/getUserPicture.do?file=${LXCX.picture}"
									onerror="this.onerror=null;this.src='${ctx}/image/WT.png'"
									alt="" border="0" height="200" width="200"> </a> <span
								class="l_c"> <a class="a_1"
									onclick="LJDHone(${LXCX.integralstoreid},'${SESSION_USER.signupId}',${LXCX.integral})">立即兑换</a>
									<!-- <a class="a_2" href="" target="_blank">查看详情</a> --> </span>
								<div class="prd-des">
									<p class="prd-name" title="${LXCX.storemc}">${LXCX.storemc}</p>
									<p class="orange fz12">
										<span>积分：${LXCX.integral} <i class="zuanshi"></i> </span> <span>已兑换：${LXCX.intzhi}个</span>
									</p>
								</div></li>
						</c:forEach>
							...
							<div class="col-lg-12">
								<div style="width: 70%;">
									<i class="shop_icon s_phone"></i><input type="text"
										...
										placeholder="电话" id="telephone"  maxlength="11"
	...
	<script type="text/javascript"
		src="${ctx}/assets/plugins/jquery.form-3.46.0/jquery.form.js"></script>
...
<script type="text/javascript">
  ...
  function LJDHone(id,huyuanID,jifenB) {
       ...
       var ID=id;// undefined
       var varstr = "${SESSION_USER.signupname}";
